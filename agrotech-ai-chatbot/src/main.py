...
premade_requests = {
    ...
    "What features does KisaanSetu offer?": (
...
@app.route('/KisaanSetu-ChatBot', methods=['POST'])
def chat():
    ...
    messages = [
        {'role': "system", "content": "You are an AI assistant for KisaanSetu, an innovative platform that leverages artificial intelligence to enhance agricultural practices. Provide helpful and accurate information about KisaanSetu's services and agricultural technology."},
